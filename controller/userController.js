...
async function sendOrderConfirmationEmail(email, username, userId, newOrder) {
  try {
    ...
    const mailOptions = {
      ...
      subject: 'www.mittalsweetandsnacks.com Order Confirmation',
    ...
    <thead>
      ...
      <img width="200" src="https://mittal-back-olb5.onrender.com/uploads/new/image-1768651630068.webp" />
 </th>
            ...
            <div className="d-flex mb-2">
              ...
              <div className="flex-lg-grow-1 ms-3">
                <h6 className="small mb-0">
                  <a hreff="https://mittalsweetandsnacks.com/product/${Pro.id}" style="font-size:10px;">
                    ${Pro.title}  
                  </a>
                </h6>
    ...
    <tfooter>
      <tr>
        <td colspan="2" style="font-size:14px;padding:50px 15px 0 15px;">
          ...
          <address><strong class="mb-2"> Mittalsweetandsnacks </strong><br>
          <b title="Phone" class="mb-2">Web:</b>www.mittalsweetandsnacks.com <br></address>
